...
Welcome to ``PyIMAPFeed`` contributor's guide.
...
If you experience bugs or general issues with ``PyIMAPFeed``, please have a look
...
You can help improve ``PyIMAPFeed`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``PyIMAPFeed`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``PyIMAPFeed``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n PyIMAPFeed python=3 six virtualenv pytest pytest-cov
    conda activate PyIMAPFeed
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/PyIMAPFeed.git
    cd PyIMAPFeed
...
#. Install |pre-commit|_::
   ...
   ``PyIMAPFeed`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/PyIMAPFeed
.. _issue tracker: https://github.com/<USERNAME>/PyIMAPFeed/issues
.. <-- end -->
